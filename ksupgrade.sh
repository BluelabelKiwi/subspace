...
echo -e "\e[1m\e[32m1. Kullanilmayan Kutuphaneler Temizleniyor... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m3. SubSpace Node/Farmer Durduruluyor... \e[0m" 
...
echo -e "\e[1m\e[32m3. Eski versiyon temizleniyor... \e[0m" 
rm -rf /usr/local/bin/subspace* && sleep 1

echo "=================================================="

echo -e "\e[1m\e[32m3. SubSpace Guncel node binary indiriliyor... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m4. SubSpace Guncel farmer binary indiriliyor... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m Farmer imzali bloklari gormek icin Odul blok baslangici itibariyle: \e[0m" 
