...
sudo rm -rf /usr/local/bin/subspace* && sleep 1
...
echo -e "\e[1m\e[32m10. Dosya izinleri ayarlaniyor subspace-farmer & subspace-node.. \e[0m" 
...
sudo systemctl enable subspace-farmer.service && sleep 1
echo -e "\e[1m\e[32mNode Yeniden Baslatiliyor.. \e[0m"
sudo systemctl enable subspace-node.service && sleep 2

sudo systemctl start subspace-node.service && sleep 1
sudo systemctl start subspace-farmer.service && sleep 1

echo "=================================================="

echo -e "\e[1m\e[32m Node Basladi \e[0m"
echo -e "\e[1m\e[32m Farmer Basladi \e[0m"
...
echo -e "\e[1m\e[93mGuncelleme Tamamlandi \e[0m" 
